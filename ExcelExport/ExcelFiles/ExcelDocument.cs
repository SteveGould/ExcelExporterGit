...
namespace ExcelExport
{
	...
	{
		private string creator = "GigaFoo, Inc.";

		// Creates a SpreadsheetDocument.
		public MemoryStream CreatePackage()
		{
			MemoryStream excelMS = new MemoryStream();

			using (SpreadsheetDocument package = SpreadsheetDocument.Create(excelMS, SpreadsheetDocumentType.Workbook))
			{
				CreateParts(package);
			}
		...
		private void GenerateExtendedFilePropertiesPart1Content(ExtendedFilePropertiesPart extendedFilePropertiesPart1)
		{
			...
			company1.Text = "Intel Corporation";
		...
		private void GenerateWorkbookPart1Content(WorkbookPart workbookPart1)
		{
			...
			WorkbookView workbookView1 = new WorkbookView() { XWindow = 120, YWindow = 30, WindowWidth = (UInt32Value)25875U, WindowHeight = (UInt32Value)10035U };
